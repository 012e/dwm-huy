...
static const char *screenshotcmd1[] = { "spectacle", "--region", NULL };
static const char *screenshotcmd2[] = { "spectacle", "--activewindow", NULL };
static const char *screenshotcmd3[] = { "spectacle", "--fullscreen", NULL };
